...
def reward_function(params):
    ...
    # Hàm này sẽ xác định các góc cua trong tương lai mà xe sẽ tới
    def identify_corner(waypoints, closest_waypoints, future_step):

        # Tính hướng của đường trung tâm của đường đua hiện tại
        point_prev = waypoints[closest_waypoints[0]]
        point_next = waypoints[closest_waypoints[1]]

        #Tính hướng của đường trung tâm của đường đua tương lai mà xe sẽ tới trong 7 bước tiếp theo
